...
public class GridPaneEjemplo extends Application {
    ...
    public void start(Stage stage) {
         ...
         * De forma predeterminada, el panel muestra sus elementos secundarios en sus tamaños preferidos 
         * y no los agranda cuando se amplía la ventana. Creamos restricciones de columna, 
         * donde establecemos la prioridad de crecimiento horizontal en Priority.ALWAYS para la segunda columna. 
         * Esto hace que el campo de texto y los controles de la vista de lista crezcan en dirección horizontal 
         * a medida que se agranda la ventana.
         */
