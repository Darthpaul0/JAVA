...
public class VistaPrincipalController implements Initializable {
    ...
    @FXML
    private MenuItem btnitemListar;
    @FXML
    private MenuItem subitemSubirSueldo;
    @FXML
    private MenuItem subitemModificarVacaciones;
    @FXML
    private MenuItem subitemBajarSueldo;
    @FXML
    private MenuItem subitemPlus;
    @FXML
    private MenuButton menubtnVehiculos;
    @FXML
    private Button btnEconomia;
    @FXML
    private Button btnSalir;
    @FXML
    private MenuItem btnitemBuscarVehiculo;
    @FXML
    private MenuItem btnitemVenderVehiculo;
    @FXML
    private MenuItem btnitemAñadir;
    @FXML
    ...
    private void despedirVendedor(ActionEvent event) {
        try {
            ...
            // Cargo la vista
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/vista/VistaDNI.fxml"));

            // Cargo la ventana
            Parent root = loader.load();

            // Cojo el controlador
            ValidarDNIController despidiendo = loader.getController();
            despidiendo.inicializarAtributos(vendedores);
            ...
            // cojo la persona devuelta
            Vendedor vende = despidiendo.getVendedor();
            if (vende != null) {
    ...
    @FXML
    private void listarVendedores(ActionEvent event) {
        Alert alert = new Alert(Alert.AlertType.INFORMATION);
        alert.setHeaderText(null);
        alert.setTitle("Listado de vendedores");
        alert.setContentText(vendedores.toString());
        alert.showAndWait();
    }
