...
public abstract class Vehículo implements Serializable {
    ...
    public Vehículo(int peso, int ancho, int largo, int altura, String color, double precio, String matricula, int km, int ruedas, int cilindrada, int potencia, String combustible) {
        ...
        if (!matricula.matches("([0-9]{4})([A-Z]{3})")) {
            ...
            alert.setContentText("La matrícula debe tener el formato 0000XXX");
            alert.showAndWait();
    ...
    public void setPeso(int peso) {
        if (peso < 0) {
            ...
            alert.setHeaderText(null);
            alert.setTitle("Error");
            alert.setContentText("El peso del vehículo no puede ser negativo");
            alert.showAndWait();
    ...
    public void setAncho(int ancho) {
        if (ancho < 0) {
            ...
            alert.setHeaderText(null);
            alert.setTitle("Error");
            alert.setContentText("El ancho del vehículo no puede ser negativo");
            alert.showAndWait();
    ...
    public void setLargo(int largo) {
        if (largo < 0) {
            ...
            alert.setHeaderText(null);
            alert.setTitle("Error");
            alert.setContentText("El largo del vehículo no puede ser negativo");
            alert.showAndWait();
    ...
    public void setAltura(int altura) {
        if (altura < 0) {
            ...
            alert.setHeaderText(null);
            alert.setTitle("Error");
            alert.setContentText("La altura del vehículo no puede ser negativo");
            alert.showAndWait();
    ...
    public void setPrecio(double precio) {
        if (precio < 0) {
            ...
            alert.setHeaderText(null);
            alert.setTitle("Error");
            alert.setContentText("El precio del vehículo no puede ser negativo");
            alert.showAndWait();
    ...
    public void setKm(int km) {
        if (km < 0) {
            ...
            alert.setHeaderText(null);
            alert.setTitle("Error");
            alert.setContentText("Los kilómetros del vehículo no pueden ser negativo");
            alert.showAndWait();
    ...
    public void setRuedas(int ruedas) {
        if (ruedas < 2 || ruedas > 4) {
            ...
            alert.setHeaderText(null);
            alert.setTitle("Error");
            alert.setContentText("Un vehículo debe tener entre dos ruedas y cuatro ruedas.");
            alert.showAndWait();
    ...
    public void setCilindrada(int cilindrada) {
        if (cilindrada < 0) {
            ...
            alert.setHeaderText(null);
            alert.setTitle("Error");
            alert.setContentText("La cilindrada del vehículo no puede ser negativa");
            alert.showAndWait();
    ...
    public void setPotencia(int potencia) {
        if (potencia < 0) {
            ...
            alert.setHeaderText(null);
            alert.setTitle("Error");
            alert.setContentText("La potencia del vehículo no puede ser negativa");
            alert.showAndWait();
            throw new IllegalArgumentException("La potencia del vehículo no puede ser negativa");
        } else {
            this.potencia = potencia;
        }
    }
